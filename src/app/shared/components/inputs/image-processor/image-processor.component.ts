import { Component, Input, OnChanges, ChangeDetectorRef, inject, signal, computed, Signal, ViewChild } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { ImageCropperComponent, CropperPosition, ImageCroppedEvent } from 'ngx-image-cropper';
